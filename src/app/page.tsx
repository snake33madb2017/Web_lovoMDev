...
export default function Home() {
  return (
    <main className="fixed inset-0 h-[100dvh] z-[100] flex flex-col bg-black overflow-hidden">
      ...
      <div className="relative h-[30%] md:h-[55%] w-full shrink-0">
        <Image
          src="/portada.jpg"
      ...
      <div className="relative flex-1 bg-black flex flex-col items-center justify-center px-4 py-2 md:pb-12 w-full max-w-2xl mx-auto z-20">
        ...
        <h2 className="text-lg md:text-3xl font-playfair text-white mb-3 md:mb-6 text-center italic font-light drop-shadow-md leading-tight">
          La mejor coctelería,<br />
          <span className="text-[#D3A548]">preparada en el momento</span>
        </h2>

        {/* Info Horario y Ubicación */}
        <div className="w-full flex justify-between text-white/80 text-xs md:text-sm font-light mb-3 md:mb-8 px-1">
        ...
        <div className="w-full flex flex-col gap-2 md:gap-4 mt-1 md:mt-2">
        ...
        <div className="flex items-center justify-center gap-3 md:gap-4 mt-3 md:mt-8 flex-wrap pb-2 md:pb-0">
